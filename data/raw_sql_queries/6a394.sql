...
AND (mi1.info IN ('MET:','MET:150 m','MET:300 m','MET:600 m'))
AND (it1.id IN ('1','7'))
AND it3.id = '100'
AND it4.id = '101'
...
AND (n.name_pcode_nf in ('A4163','A5352','A5362','C6421','C6423','C6424','C6426','E6523','F6524','F6525','M6263','R1631','R1632') OR n.name_pcode_nf IS NULL)
